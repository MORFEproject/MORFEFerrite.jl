...
function _with_gmsh(path::AbstractString, f::Function)
    gmsh.initialize()
    try
        gmsh.open(path)
        return f()
...
@testset "Abaqus to Gmsh" begin
    mktempdir() do directory
        ...
        abaqus_to_gmsh(c3d20, c3d20_out)
        ...
        abaqus_to_gmsh_linear(c3d20, linear_out)
        ...
        abaqus_to_gmsh(sparse_ids, sparse_out)
...
@testset "COMSOL and Gmsh round trips" begin
    mktempdir() do directory
        ...
        comsol_to_gmsh(joinpath(comsol_dir, "single_t10.mphtxt"), t10_out)
        ...
        comsol_to_gmsh_linear(joinpath(comsol_dir, "single_t10.mphtxt"), t10_linear_out)
        ...
        gmsh_to_comsol(h27_out, roundtrip_comsol)
        comsol_to_gmsh(roundtrip_comsol, roundtrip_gmsh)
        @test _element_data(roundtrip_gmsh, 12).connectivity == h27.connectivity
        ...
        comsol_to_gmsh_linear(arch, arch_linear_out)
